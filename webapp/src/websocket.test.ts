...
describe('WebSocketClient', () => {
    ...
    describe('message handling', () => {
        ...
        it('should emit join event for plugin join messages', () => {
            ...
            const joinMessage = {
                event: 'custom_com.fambear.calls_join',
        ...
        it('should emit error for plugin error messages', () => {
            ...
            const errorMessage = {
                event: 'custom_com.fambear.calls_error',
        ...
        it('should emit message for plugin signal messages', () => {
            ...
            const signalMessage = {
                event: 'custom_com.fambear.calls_signal',
    ...
    describe('sending messages', () => {
        ...
        it('should send JSON messages when connection is open', () => {
            ...
            expect(sendSpy).toHaveBeenCalledWith('{"action":"custom_com.fambear.calls_test_action","seq":1,"data":{"test":"data"}}');
        });
